...
- **MMI Login (Community Connect):** [MMI-Login on Figma](https://www.figma.com/design/8yGQMV0q1Yg0XoNAQnFTEd/MMI-Login?t=zo59mquEiT3ZRmMO-0) — file key: `8yGQMV0q1Yg0XoNAQnFTEd`, nodeId: `0:1` — **implemented** in `public/index.html` and `public/css/login.css`
- **Dashboard (Community Connect):** [Untitled / Community Connect](https://www.figma.com/design/VywQr6kXMi3hPy2Gg76Ntx/Untitled?node-id=0-1) — file key: `VywQr6kXMi3hPy2Gg76Ntx`, nodeId: `0:1` — **implemented** in `public/app.html` (#page-dashboard) and `public/css/dashboard.css`
